<div class="sidebar">
    ...
    {{-- <div class="newsletter">
        <div class="title">Fique por dentro</div>
        <div class="subtitle">Cadastre-se e fique por dentro das principais notícias do setor</div>
        <div class="form">
            <div class="input">
            ...
            <div class="submit">
                <span class="bt-primary-one">Inscrever-se</span>
            </div>
        </div>
    </div> --}}
    {{-- <x-edition /> --}}
