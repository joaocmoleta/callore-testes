@extends('templates.main', ['og_title' => 'Política de Privacidade do Aquecedor de Toahas Callore'])
@section('content')
    @include('flash-message')
    <section class="guaranteed">
        <h1>Política Privacidade do Aquecedor de Toalhas</h1>
        <p>A sua privacidade é importante para nós. É política do Aquecedor de Toalhas respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site Aquecedor de Toalhas, e outros sites que possuímos e operamos.</p>
        ...
        <h3>Política de Cookies Aquecedor de Toalhas</h3>
        ...
        <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Aquecedor de Toalhas oferece no site e com caráter enunciativo, mas não limitativo:</p>
        <ul>
            <li>A) Não se envolver em atividades que sejam ilegais ou contrárias à boa fé a à ordem pública;</li>
            <li>B) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Aquecedor de Toalhas, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>
        </ul>
        <h4>Mais informações</h4>
        <p>Esperemos que esteja esclarecido e, como mencionado anteriormente, se houver algo que você não tem certeza se precisa ou não, geralmente é mais seguro deixar os cookies ativados, caso interaja com um dos recursos que você usa em nosso site.</p>
        <p>Esta política é efetiva a partir de Maio de 2021.</p>
    </section>
@endsection
