...
<body>
    ...
    <section class="form-area">
        <form action="{{ route('password.store') }}" method="POST" class="login-form" onsubmit="sendForm(this)">
            @csrf
            
            <input type="hidden" name="token" value="{{ $request->route('token') }}">
            
            <div class="input">
                <p>Confirme seu e-mail e insira uma nova senha:</p>
            </div>
            ...
            <div class="submit">
                <button type="submit" class="bt-primary-one">Concluir</button>
            </div>

            <div class="alternative-login">
                <p>Criar nova conta? <a href="{{ route('register') }}"><strong>Cadastre-se</strong></a></p>
            </div>
        </form>
    </section>
